...
public class MediasManager {
    ...
    public ImageObject createImage(Bundle mediaInfo) {
        ...
        img.versionCode = Integer.valueOf(mediaInfo.getString(TpAndroidXMLParser.KEY_VERSION_CODE));
        return img;
    }
    ...
    public MediaObject createMedia(Bundle mediaInfo) {
        ...
        media.versionCode = Integer.valueOf(mediaInfo.getString(TpAndroidXMLParser.KEY_VERSION_CODE));
    ...
    public ArrayList<MediaObject> getVideos() {
        ArrayList<MediaObject> videos = new ArrayList<MediaObject>();
        for (MediaObject mediaObject : mMediasList) {
            if (mediaObject.type.equals(Global.MEDIA_TYPE_VIDEO)) {
    ...
    public ArrayList<MediaObject> getText() {
        ArrayList<MediaObject> textes = new ArrayList<MediaObject>();
        for (MediaObject mediaObject : mMediasList) {
            if (mediaObject.type.equals(Global.MEDIA_TYPE_TEXT)) {
                textes.add(mediaObject);
            }
        }
