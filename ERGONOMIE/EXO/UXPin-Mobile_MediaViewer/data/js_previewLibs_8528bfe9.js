...
;(function dmsDPElement_Preview_Navigation_ItemScope(global) {

  var dmsDPElement_Preview_Navigation_Item = function(pEl, pType) {
    this.mEl = pEl;
  ...
  dmsDPElement_Preview_Navigation_Item.prototype.setWidth = function() {
    var max = 0;
    var fragment = document.createDocumentFragment();

    Array.prototype.forEach.call(this.mEl.querySelectorAll('li span'), function(pEl) {
      var el = pEl.querySelector('em');
    ...
    fragment = null;
    this.mEl.style.width = max + 'px';
  };

  dmsDPElement_Preview_Navigation_Item.prototype.attachEvents = function() {
    this.mEl.parentNode.addEventListener('mouseenter', this.show.bind(this));
    this.mEl.parentNode.addEventListener('mouseleave', this.hide.bind(this));
  };

  dmsDPElement_Preview_Navigation_Item.prototype.show = function() {
  ...
  dmsDPElement_Preview_Navigation_Item.prototype.hide = function() {
    this.mEl.style.display = 'none';
  };

  dmsDPElement_Preview_Navigation_Item.prototype.showHorizontal = function() {
    var el = this.mEl.parentNode;
    var top = el.offsetTop - el.scrollTop + el.clientTop + el.offsetHeight;
    var left =  0;

    this.mEl.style.position = 'absolute';
    this.mEl.style.top = top + 'px';
    this.mEl.style.left = left + 'px';
  };

  dmsDPElement_Preview_Navigation_Item.prototype.showVertical = function() {
    var el = this.mEl.parentNode;
    var top =  1;
    var left = el.offsetLeft - el.scrollLeft + el.clientLeft + el.offsetWidth;
  ...
  global.dmsDPElement_Preview_Navigation_Item = dmsDPElement_Preview_Navigation_Item;

})(window);

;(function dmsDPElement_Preview_NavigationScope(global) {

  var dmsDPElement_Preview_Navigation = function(pEl, pType) {
    this.mEl = pEl;
    this.mActiveBgColor = null;
    this.mInactiveBgColor = null;

    Array.prototype.forEach.call(pEl.querySelectorAll('li > ul'), function(pChildListEl) {
      var type = null;

      // if second level menu, set type
      if (pChildListEl.parentNode.parentNode.id == pEl.id) {
        type = pType;
      }

      new dmsDPElement_Preview_Navigation_Item(pChildListEl, type);
    });
  };

  dmsDPElement_Preview_Navigation.prototype.setBgColors = function(pActive, pInactive) {
    ...
    Array.prototype.forEach.call(this.mEl.querySelectorAll('li.inactive.main'), function(pEl) {
      pEl.addEventListener('mouseover', function() {
        pEl.style.backgroundColor = this.mActiveBgColor;
      }.bind(this));

      pEl.addEventListener('mouseout', function() {
        pEl.style.backgroundColor = this.mInactiveBgColor;
      }.bind(this));
    }.bind(this));
  };

  global.dmsDPElement_Preview_Navigation = dmsDPElement_Preview_Navigation;
...
;(function FeatureTogglerScope(global) {
  ...
  var FeatureToggler = function(data) {
...
//# sourceMappingURL=maps/previewLibs.js.map